...
const Admin = () => {
  ...
  return (
    ...
    <EndElection electionState={state.endElection} endElection={actions.endElection} isClose={actions.endElectionModal} isOpen={state.endElectionModal}/>
    </Box>
