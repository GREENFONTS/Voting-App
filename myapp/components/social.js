...
const Socials = (props) => {
    const iconColor = useColorModeValue('themeLight.icon', 'themeLight.icon');
      ...
      return (
        ...
        <a href='https://www.linkedin.com/in/godwill-onyewuchi-6746621b4/' target='_blank' _hover={{ transform: 'scale(1.05)', cursor: "pointer" }}>
          ...
          <a href='https://twitter.com/GODWILLONYEWUC1' target='_blank' _hover={{ transform: 'scale(1.05)', cursor: "pointer" }}>
          ...
          <a href='https://www.instagram.com/onyewuchigodwill/' target='_blank'  _hover={{ transform: 'scale(1.05)', cursor: "pointer" }}>
          ...
          <a href='https://github.com/GREENFONTS' target='_blank' _hover={{ transform: 'scale(1.05)', cursor: "pointer" }}>
